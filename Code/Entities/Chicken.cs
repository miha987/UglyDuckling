...
namespace UglyDuckling.Code.Entities
{
	class Chicken : Entity
	{
		...
		public Chicken(double idleTimePerFrame = 0.0833, double danceTimePerFrame = 0.055556) : base(Vector2.Zero)
		{
		...
		public void InitializeAnimations(double idleTimePerFrame = 0.0833, double danceTimePerFrame = 0.055556)
		{
			EnableAnimator(6, 10);
